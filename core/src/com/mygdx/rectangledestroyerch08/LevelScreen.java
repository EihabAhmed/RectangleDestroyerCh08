...
public class LevelScreen extends BaseScreen {
    ...
    public void update(float dt) {
        ...
        for (BaseActor wall : BaseActor.getList(mainStage, "com.mygdx.rectangledestroyerch08.Wall")) {
        ...
        for (BaseActor brick : BaseActor.getList(mainStage, "com.mygdx.rectangledestroyerch08.Brick")) {
            if (ball.overlaps(brick)) {
                ...
                if (BaseActor.getList(mainStage, "com.mygdx.rectangledestroyerch08.Brick").size() == 0) {
        ...
        if (ball.getY() < -50 && BaseActor.getList(mainStage, "com.mygdx.rectangledestroyerch08.Brick").size() > 0) {
            ball.remove();
        ...
        for (BaseActor item : BaseActor.getList(mainStage, "com.mygdx.rectangledestroyerch08.Item")) {
